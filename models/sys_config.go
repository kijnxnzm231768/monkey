...
type SysConfig struct {
	ConfigId    int       `xorm:"pk autoincr" json:"configId"`    //主键id
	ConfigName  string    `xorm:"varchar(100)" json:"configName"` //参数名称
	ConfigKey   string    `xorm:"varchar(100)" json:"configKey"`  //参数建名
	ConfigValue string    `xorm:"varchar(1)" json:"configValue"`  //参数键值
	ConfigType  string    `xorm:"char(1)" json:"configType"`      //系统内置（Y是 N否）
